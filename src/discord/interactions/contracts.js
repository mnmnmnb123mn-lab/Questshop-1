...
export const ROUTE_CONTRACTS = Object.freeze({
  ...
  admin_monitor_check_all: admin('BUTTON', 'UPDATE'),
  admin_monitor_select: admin('STRING_SELECT'),
  admin_monitor_edit: admin('BUTTON', 'MODAL'),
  admin_monitor_check_one: admin('BUTTON', 'UPDATE'),
  ...
  admin_order_refund: admin('BUTTON', 'MODAL'),
  admin_order_refund_submit: admin('MODAL_SUBMIT'),
  admin_order_refund_confirm: admin('BUTTON', 'UPDATE'),
  admin_topup_lookup: admin('BUTTON', 'MODAL'),
  admin_topup_lookup_submit: admin('MODAL_SUBMIT'),
  admin_topup_select: admin('STRING_SELECT'),
  admin_topup_reverse: admin('BUTTON', 'MODAL'),
  admin_topup_reverse_submit: admin('MODAL_SUBMIT'),
  admin_topup_reverse_confirm: admin('BUTTON', 'UPDATE'),
  admin_audit: admin('BUTTON', 'UPDATE'),
  admin_containment_probe: admin('BUTTON', 'MODAL'),
  admin_containment_probe_submit: admin('MODAL_SUBMIT'),
