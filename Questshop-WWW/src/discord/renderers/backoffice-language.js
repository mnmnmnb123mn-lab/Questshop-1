...
const incidents = Object.freeze({
  ...
  POSTGRES_RUNTIME_ROLE_CONTRACT_FAILED: ['สิทธิ์ฐานข้อมูลไม่ตรงตามที่ระบบต้องใช้', 'ระบบอาจทำงานบางส่วนไม่ได้', 'ผู้ดูแลต้องตรวจสิทธิ์ฐานข้อมูล'],
  PG_DUMP_SPAWN_FAILED: ['เริ่มเครื่องมือสำรองข้อมูลไม่ได้', 'รอบสำรองข้อมูลนี้ยังไม่ทำงาน', 'ผู้ดูแลควรตรวจเครื่องมือสำรองข้อมูล'],
  ...
  RUNTIME_MIGRATOR_ROLE_CONFLICT: ['บทบาทระบบฐานข้อมูลตั้งค่าซ้ำกัน', 'ระบบเริ่มทำงานต่อไม่ได้อย่างปลอดภัย', 'ผู้ดูแลต้องตรวจการตั้งค่าฐานข้อมูล'],
  RUNTIME_ROLE_REQUIRED: ['ยังไม่ได้กำหนดบทบาทระบบฐานข้อมูล', 'ระบบเริ่มทำงานต่อไม่ได้อย่างปลอดภัย', 'ผู้ดูแลต้องตั้งค่าบทบาทฐานข้อมูล'],
